...
def cartesian_to_spherical2(cartesian):
    ...
    horizontal_angle = theta*180/3.14  # Azimuthal angle
    vertical_angle =  phi*180/3.14  # Convert polar angle to vertical angle (0 at the top)
...
def turn_laser_on():
    ...
    print("Laser ON")
# Main loop
horizontal_angle, vertical_angle = cartesian_to_spherical2(target_point)
...
#    GPIO.output(LASER_PIN, GPIO.LOW)
    while True:
        ...
        target_horizontal_angle = target_horizontal_angle - horizontal_angle  #the number subtracted is the offset distance
        print(target_vertical_angle)
        print( " is target vertical angle")
        target_vertical_angle = vertical_angle #+ 189 # -171
