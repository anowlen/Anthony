...
def cartesian_to_spherical(cartesian):
    ...
    horizontal_angle = theta  # Azimuthal angle
    vertical_angle =  phi  # Convert polar angle to vertical angle (0 at the top)
...
try:
    ...
    while True:
        ...
        target_horizontal_angle, target_vertical_angle = cartesian_to_spherical(target_point)
...
#        servo_x.ChangeDutyCycle(2)
 #       servo_y.ChangeDutyCycle(7)
        ...
        time.sleep(0.1)
        if (current_horizontal_angle == target_horizontal_angle and current_vertical_angle == target_vertical_angle ):
           break
