...
LASER_PIN = 22     # Laser control pin
...
target_point = (20000,10000,1) #x y z
###########################################################################################################
...
try:
    ...
    while True:
        ...
        target_horizontal_angle = target_horizontal_angle - 110 #the number subtracted is the offset distance
        target_vertical_angle = target_vertical_angle -171
...
#####new code
    ...
    servo_x.stop()
    servo_y.stop()
    time.sleep(100) #make laser stay on
